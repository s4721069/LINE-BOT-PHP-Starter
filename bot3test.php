				...
				if(strtoupper($textArr[1])=="HY")
				{
					switch(strtoupper($textArr[2]))
					{
						...
						case "WQ" :
							...
							$replytext1.="-ถังน้ำใสขนาด 3000 ลบ.ม. (Z3)  คือ ".number_format($scada_data['Z3HY_LE1_VOLUME'],0)." ลบ.ม.\n";
							$replytext1.="-ถังน้ำใสขนาด 3000 ลบ.ม. (Z6) คือ ".number_format($scada_data['Z6HY_LE1_VOLUME'],0)." ลบ.ม.\n";
							$replytext1.="-ถังสูงขนาด 2500 ลบ.ม. (Z6) คือ ".number_format($scada_data['Z6HY_LE1_VOLUME'],0)." ลบ.ม.\n";
							$replytext1.="-ถังน้ำใสขนาด 6000 ลบ.ม. (Z7) คือ ".number_format($scada_data['Z7HY_LE1_VOLUME'],0)." ลบ.ม.\n";
							$replytext1.="-ถังน้ำใสขนาด 3500 ลบ.ม. (Z8) คือ ".number_format($scada_data['Z8HY_LE1_VOLUME'],0)." ลบ.ม.\n";
							$replytext1.="-ถังน้ำใสขนาด 3500 ลบ.ม. (Z9) คือ ".number_format($scada_data['Z9HY_LE1_VOLUME'],0)." ลบ.ม.\n";
							...
							$replytext1.="-ถังน้ำใสขนาด 1500 ลบ.ม. คือ ".number_format($scada_data['Z14KL_LE2_VOLUME'],0)." ลบ.ม.\n";
							$replytext1.="-ถังสูงขนาด 300 ลบ.ม. คือ ".number_format($scada_data['Z14KL_LE1_VOLUME'],0)." ลบ.ม.";
							$messages = [[
									'type' => 'text',
									'text' =>  $replytext1
								]];
